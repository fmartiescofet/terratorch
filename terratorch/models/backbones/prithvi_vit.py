...
def prithvi_eo_tiny(
    ...
    **kwargs,
    ...
    return _create_prithvi(
        "prithvi_eo_tiny", pretrained=pretrained, **dict({"model_bands": bands}, vit_adapter=vit_adapter, **kwargs)
    )
...
def prithvi_eo_v1_100(
    ...
    **kwargs,
    ...
    return _create_prithvi(
        "prithvi_eo_v1_100", pretrained=pretrained, **dict({"model_bands": bands}, vit_adapter=vit_adapter, **kwargs)
    )
...
def prithvi_eo_v2_300(
    ...
    **kwargs,
    ...
    return _create_prithvi(
        "prithvi_eo_v2_300", pretrained=pretrained, **dict({"model_bands": bands}, vit_adapter=vit_adapter, **kwargs)
    )
...
def prithvi_eo_v2_600(
    ...
    **kwargs,
    ...
    return _create_prithvi(
        "prithvi_eo_v2_600", pretrained=pretrained, **dict({"model_bands": bands}, vit_adapter=vit_adapter, **kwargs)
    )
...
def prithvi_eo_v2_300_tl(
    ...
    **kwargs,
    ...
    return _create_prithvi(
        "prithvi_eo_v2_300_tl", pretrained=pretrained, **dict({"model_bands": bands}, vit_adapter=vit_adapter, **kwargs)
    )
...
def prithvi_eo_v2_600_tl(
    ...
    **kwargs,
    ...
    return _create_prithvi(
        "prithvi_eo_v2_600_tl", pretrained=pretrained, **dict({"model_bands": bands}, vit_adapter=vit_adapter, **kwargs)
    )
...
def prithvi_vit_tiny(
    ...
    **kwargs,
    ...
    return prithvi_eo_tiny(pretrained=pretrained, **dict({"model_bands": bands}, vit_adapter=vit_adapter, **kwargs))
...
def prithvi_vit_100(
    ...
    **kwargs,
    ...
    return prithvi_eo_v1_100(pretrained=pretrained, **dict({"model_bands": bands}, vit_adapter=vit_adapter, **kwargs))
